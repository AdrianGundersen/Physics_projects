...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(file_path, title_absolute) + ".pdf")
plt.show()
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(file_path, title_relative) + ".pdf")
plt.show()
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(file_path, "max_relative_error") + ".pdf")
plt.show()
plt.close()