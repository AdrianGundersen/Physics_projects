...
```json
{
    ...
    "simulation": // Simulation parameters (Metropolis)
    {
        ...
        "walkers": 4 // Number of independent walkers (should be = cores for best performance)
    },
    "write_to_file": 
    {
        ...
        "average_or_concatenate": "concatenate" // average takes average over all wakers, concatenate merges all data from walkers into one file (average NEVER recommended as it loses info)
    }
}
```
