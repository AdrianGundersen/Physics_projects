...
namespace ds::solver {
    ...
    void crank_nicolson_step(SolverData& data, const ds::simParams& params, 
                            const ds::Grid& grid, const ds::Potential& V);

    void simulation(SolverData& data, const ds::simParams& params, 
                    const ds::Grid& grid, ds::PotentialParams& potential_params);
} // namespace ds::solver
