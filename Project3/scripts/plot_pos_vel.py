...
plot_component(t1, x1, t2, x2, "x(t)", "time (s)", "x-position", "data/plot/x_position_vs_time.pdf")
plot_component(t1, y1, t2, y2, "y(t)", "time (s)", "y-position", "data/plot/y_position_vs_time.pdf")
plot_component(t1, z1, t2, z2, "z(t)", "time (s)", "z-position", "data/plot/z_position_vs_time.pdf")

plot_component(x1, vx1, x2, vx2, "v_x(x)", "x-position", "x-velocity", "data/plot/v_x_vs_x.pdf")
plot_component(z1, vz1, z2, vz2, "v_z(z)", "z-position", "z-velocity", "data/plot/v_z_vs_z.pdf")
