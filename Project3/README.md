...
- Narrow windows set \texttt{w_step = 0.0005} with $\omega_V\$ as in figure captions. Then run `make run-few` with and without Coulumb forces. Set \texttt{plot_both = True} in script. 
